...
//         "alert('WebMacros: The embedded macros work with WebMacros for Chrome. Support for IE/Firefox is planned.');"+
//         "return;"+
//         "}"+
//         "if(!/^(?:chrome|https?|file)/.test(location)){"+
//         "alert('WebMacros: To run a macro, you need to open a website first.');"+
//         "return;"+
//         "}"+
//         "var div = document.getElementById(\"webmacros-bookmark-div\");"+
//         "if (!div){"+
//         "alert(\"Can not run macro, no WebMacros div found\");"+
//         "return;"+
//         "}"+
//         "var ta = document.getElementById(\"webmacros-macro-container\");"+
...
function makeBookmarklet(name, code) {
    var pattern = "(function() {"+
        ...
        "if(!/^(?:chrome|https?|file)/.test(location)){"+
        "alert('WebMacros: Open webpage to run a macro.');"+
        "return;"+
        "}"+
        "var macro = {};"+
        ...
        "}catch(e){alert('WebMacros Bookmarklet error: '+e.toString());}"+
        "}) ();";
...
function save(save_data, overwrite, callback) {
    ...
    chrome.bookmarks.getTree( function (tree) {
        ...
        ensureBookmarkFolderCreated(p_id, "WebMacros").then(function(node) {
...
function showInfo(args) {
    ...
    if (panel && !panel.closed) {
        ...
        var opt = {
            type: "basic",
            title: (args.errorCode == 1 ? "WebMacros" : "WebMacros Error"),
