...
var nm_connector = {
    ...
    handleCommand: function(clientId, cmd) {
        ...
        case "capture":
            ...
            break;
        case "error":
            console.error("Got error from WebMacros host: "+request.message);
            break;

        case "info":
            console.info("Got message from WebMacros host: "+request.message);
            break;
        }
    },
    ...
    startServer: function(args) {
        const si_host = "com.ipswitch.webmacros.host";
