...
window.addEventListener("load", function () {
    ...
    if (!Storage.getBool("afio-installed")) {
        ...
        $("<span>The File Access for WebMacros Extensions module is currently " +
            "not installed. It is not available in the freeware version. " +
            "The following functionality is not available unless you have an WebMacros license and " +
